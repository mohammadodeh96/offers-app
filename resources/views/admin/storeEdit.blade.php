                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{route('store.update' , $store->id)}}" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                          ...
                          <input type="store_name" id="store_name" value="{{$store->store_name}}" name="store_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Store ...." required>
                        </div>
                        <div class="mb-6">

                            <label for="store_location" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Store Location</label>
                            <input type="store_location" id="store_location" value="{{ $store->store_location}}" name="store_location" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Location" required>
                        </div>
                        <div class="mb-6">
                        ...
                        <div class=" mb-6">
                            ...
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300" for="favicon">Upload favicon</label>
                                 <input class="block w-fit text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" value=
                                 "{{Storage::url($store->favicon)}}" id="favicon" name="favicon" type="file">

                            <img class=" w-20 h-20" src="{{Storage::url($store->favicon)}}" alt="#">
